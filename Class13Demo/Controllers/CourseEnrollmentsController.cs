...
namespace Class13Demo.Controllers
{
    public class CourseEnrollmentsController : Controller
    {
        ...
        public CourseEnrollmentsController(EnrollmentDbContext context)
        {
            _context = context;
        }
        ...
        {
            var enrollmentDbContext = _context.CourseEnrollments.Include(c => c.Course).Include(c => c.Student);
